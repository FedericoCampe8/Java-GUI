...
public class Defs {
    ...
    public static final int FRAGMENT_NUM_PARAMETERS = 14;
    ...
    public static final int FRAGMENT_RESNO_START = 12;
    public static final int FRAGMENT_RESNO_END = 13;
    ...
    public static final String COCOS_GPU_PATH = SOLVER_PATH
                + Utilities.getSeparator()
                + "CocosGPU"
                + Utilities.getSeparator();    
