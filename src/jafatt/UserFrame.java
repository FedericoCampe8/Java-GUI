...
public class UserFrame extends JFrame implements Observer, MouseListener, ComponentListener {
    ...
    protected UpdateView upView;
    private final int LOADSAVEBUTTONCOUNT = 2;
    ...
    private void setupIcons() {
        ...
        icons[3] = currentDir + imSuffix + "nvidia.png";
        ...
        descriptions[2] = "Cocos";
        descriptions[3] = "nVidia";
    ...
    public void closeEvent(){
        int result = JOptionPane.showConfirmDialog(
                this, "Do you really want to exit?", "Fiasco - Exit",
                JOptionPane.YES_NO_OPTION, 0,
                new ImageIcon(new ImageIcon(frameIcon).getImage().getScaledInstance(70, 70,
    ...
    public void componentResized(ComponentEvent e) {
        ...
        //h = e.getComponent().getBounds().height;
        w = getBounds().width;
        h = getBounds().height;
        bin.update(w,h);
    }
    ...
    public void initProteinLoaded(int panel) {
        /* Create a new thread */
        ...
        String message = "Start the loading of the protein into ";
        if(panel == Defs.EXTRACTION)
            printStringLn(message
                + "the Extration panel");
        else if(panel == Defs.OUTPUT)
            printStringLn(message
                + "the Output panel");
    }//initProtinLoaded
    ...
    public void proteinLoaded() {
       ...
       /* Print some infos */
        ...
        printStringLn("Note: "
                + "If something goes wrong with the selection of "
                + "the fragments, please check the PDB file first");
    }//proteinLoaded
    ...
    public void fragmentsNotLoaded() {
        barPanel.stop();
        printStringLn("Error on transfer");
    }//proteinLoaded
