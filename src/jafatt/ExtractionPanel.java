...
public class ExtractionPanel extends MolPanel{
    ...
    @Override
    public void viewPdb() {
        viewPdb(view, exOP.structureSequence, Defs.EXTRACTION);
    }
    ...
    public void changeView(){        
        changeViewProtein(view, exOP.structureSequence, Defs.EXTRACTION);  
    }
    
    @Override
    public void saveProtein(){
        saveEvent(view, exOP.structureSequence, Defs.EXTRACTION);
    }
