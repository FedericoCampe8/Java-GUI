...
public class AssemblingPanel extends MolPanel{
    ...
    @Override
    public void viewPdb(){
        viewPdb(view, asOP.structureSequence, Defs.ASSEMBLING);
    }
    
    @Override
    public void deselectFragments(){
        //only for extraction panel
    }
    
    @Override
    public void changeView(){
        changeViewProtein(view, asOP.structureSequence, Defs.ASSEMBLING);
    }
    
    @Override
    public void saveProtein(){
        saveEvent(view, asOP.structureSequence, Defs.ASSEMBLING);
    }
