...
public class StructureViewPanel extends JPanel{
    ...
    //private JmolAwtPopup jmolpopup;
    ...
    public String getLoadedFile(){
        String file = (String)viewer.getProperty("string","fileName",null);
        return file;
    }
    ...
    public String getMeasurements(){
        ...
        while(!model.equals("")){
            ...
            i++;
            model = ((String)viewer.getProperty("string","measurementInfo["+i+"]",null));
            cms = cms + Defs.tab1 + "--distance-leq " + resno1 +" "+ resno2 + " " + distance + " \\\n";
        }
