...
public class Utilities{
    ...
    public static String selectFragmetString(ArrayList<Fragment> selectedFragmentsA){
        ...
        for(int i = 0; i < z; i++){
            ...
            cmd = cmd + frg.getParameters()[Defs.FRAGMENT_RESNO_START] + "-"
                    + frg.getParameters()[Defs.FRAGMENT_RESNO_END];
            if(z == i+1)
                break;
            cmd = cmd + " or ";
    ...
    public static String switchViewString(String viewOption){
        ...
        return newView + "color structure; select *.CA; color red; select *; select not *;";
    }//switchViewString
