...
public class HeaderPdb {
    ...
    private static String targetSequence = "", pdbTargetSequence = "";
    private static int firstAA,lastAA,lastAAH;
    
    public static void info(String proteinPath){
        
        if(!pdbTargetSequence.equals(""))
            return;
        
        String[] text;
        String amino = "", numberAA = "";
        int aa = -1;
        firstAA = -1;
        lastAA = -1;
        ...
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if(text[0].equals("ATOM")){
                    if(!text[5].equals(numberAA)){
                        numberAA = text[5];
                        pdbTargetSequence += parse(text[3]);
                    }
                }
    ...
    public static String getPdbTargetSequence(){
        return pdbTargetSequence;
    }
