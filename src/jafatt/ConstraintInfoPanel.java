...
public class ConstraintInfoPanel extends JFrame implements Runnable {
    ...
    private OpButton closeButton;

    public ConstraintInfoPanel(UserFrame view) {
        super("Info");
        ...
        double widthFrame = (w * 50.0) / 100.0;  //960
        double heightFrame = (h * 75.0) / 100.0;  //540
        ...
        closeButton = new OpButton("Close", "") {
            @Override
