...
public class UpdateView{
    ...
    public void newStructure(){
        ...
        HeaderPdb.info(model.getCurrentPath());
    ...
    public void addFragment(Fragment frg){
        ...
        int start = Integer.parseInt(frg.getParameters()[Defs.FRAGMENT_RESNO_START]);
        //int end = Integer.parseInt(frg.getParameters()[Defs.FRAGMENT_END_AA]);
        int end = Integer.parseInt(frg.getParameters()[Defs.FRAGMENT_RESNO_END]);
        cmd = "select resno >=" + start + " and resno <=" + end + " and not {*.CG}";
