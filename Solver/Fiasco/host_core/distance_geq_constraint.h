...
#ifndef FIASCO_DISTANCE_GEQ_CONSTRAINT_
#define FIASCO_DISTANCE_GEQ_CONSTRAINT_

#include "constraint.h"

class DistanceGEQConstraint : public Constraint {
 private:
  real squared_distance;

 public:
  DistanceGEQConstraint(int argc, char* argv[], int& parse_pos, int weight = 3);
  ~DistanceGEQConstraint();
